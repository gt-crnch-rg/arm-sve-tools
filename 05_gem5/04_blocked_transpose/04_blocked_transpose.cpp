...
void naive_multiply(double ** __restrict matA, double ** __restrict matB, double ** __restrict matC, double ** __restrict matBP,
...
int main(int argc, char** argv)
{
    ...
    naive_multiply(matA, matB, matC, matBP, n, m, l);
